...
augroup vim-go-buffer
  ...
  if !exists('##TextChangedP')
    autocmd TextChanged,TextChangedI,TextYankPost,FileReadPost,FilterReadPost <buffer> call go#lsp#SetBufferChanged()
  else
    autocmd TextChanged,TextChangedI,TextChangedP,TextYankPost,FileReadPost,FilterReadPost <buffer> call go#lsp#SetBufferChanged()
  endif
