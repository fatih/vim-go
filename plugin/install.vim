...
if !exists("g:goimports_bin")
    let g:goimports_bin =  s:bin_path . "goimports"
endif
...
if !exists("g:godef_bin")
    let g:godef_bin = s:bin_path . "godef"
endif
...
if !exists("g:oracle_bin")
    let g:oracle_bin = s:bin_path . "oracle"
endif
...
if !exists("g:golint_bin")
    let g:golint_bin = s:bin_path . "golint"
endif
