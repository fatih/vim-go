...
if go#config#HighlightFunctionArguments()
  syn match goSimpleArguments   /(\(\w\|\_s\|[*\.\[\],\{\}<>-]\)*)/ contained contains=goArgumentName,goType nextgroup=goFunctionReturn skipwhite skipnl
  syn match goFunctionReturn    /(\(\w\|\_s\|[*\.\[\],\{\}<>-]\)*)/ contained contains=goArgumentName,goType skipwhite skipnl
